...
export default function CalculatorDisclaimer({ text }: CalculatorDisclaimerProps = {}) {
  ...
  return (
    ...
    >
      <p 
        className={`text-red-600 transition-all duration-300 cursor-help whitespace-pre-wrap ${
          isHovered 
