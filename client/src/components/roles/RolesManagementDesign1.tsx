...
const permissions: Permission[] = [
  ...
  { resource: "Guest Access", type: "page", parentId: "Footer - Platform Links" },
  { resource: "Client Login", type: "page", parentId: "Footer - Platform Links" },
  { resource: "Mobile App", type: "page", parentId: "Footer - Platform Links" },
  { resource: "API Documentation", type: "page", parentId: "Footer - Platform Links" },
  { resource: "Footer - Resources Links", type: "category", parentId: "FOOTER LINKS", icon: "📚" },
  { resource: "Articles & Insights", type: "page", parentId: "Footer - Resources Links" },
  { resource: "Video Library", type: "page", parentId: "Footer - Resources Links" },
  { resource: "Market Newsletters", type: "page", parentId: "Footer - Resources Links" },
  { resource: "FAQ Database", type: "page", parentId: "Footer - Resources Links" },
  { resource: "Help Center", type: "page", parentId: "Footer - Resources Links" },
  { resource: "Footer - Company Links", type: "category", parentId: "FOOTER LINKS", icon: "🏢" },
  { resource: "About IFS Group", type: "page", parentId: "Footer - Company Links" },
  { resource: "Leadership Team", type: "page", parentId: "Footer - Company Links" },
  { resource: "Careers", type: "page", parentId: "Footer - Company Links" },
  { resource: "Press & Media", type: "page", parentId: "Footer - Company Links" },
  { resource: "Contact Us", type: "page", parentId: "Footer - Company Links" },
  { resource: "Footer - Social Media Links", type: "category", parentId: "FOOTER LINKS", icon: "📱" },
  { resource: "LinkedIn", type: "page", parentId: "Footer - Social Media Links" },
  { resource: "Twitter/X", type: "page", parentId: "Footer - Social Media Links" },
  { resource: "Facebook", type: "page", parentId: "Footer - Social Media Links" },
