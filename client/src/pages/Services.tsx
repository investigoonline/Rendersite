      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {pageHeader && (
          <div className="text-center mb-12 sm:mb-16 px-4">
            ...
            <HTMLContent content={pageHeader.description} className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto" />
          </div>
        )}
        ...
        {processData && processData.steps && (
          <Card className="mb-12 sm:mb-16 mx-4" data-testid="section-process">
            <CardHeader className="text-center">
              ...
              <HTMLContent content={processData.description} className="text-muted-foreground" data-testid="text-process-description" />
            </CardHeader>
            <CardContent>
                ...
                {processData.steps.map((step: any, index: number) => {
                  ...
                  return (
                    <div key={index} className="text-center" data-testid={`process-step-${index}`}>
                      ...
                      <HTMLContent content={step.description} className="text-sm text-muted-foreground" data-testid={`text-step-description-${index}`} />
                    </div>
                  );
                })}
              </div>
                  ...
                  return (
                    <div key={index} className="flex items-start space-x-4" data-testid={`reason-${index}`}>
                      ...
                      <div>
                        ...
                        <HTMLContent content={reason.description} className="text-muted-foreground text-sm" data-testid={`text-reason-description-${index}`} />
                      </div>
                    </div>
                  );
                })}
        ...
        {ctaData && (
          <Card className="border-primary/20 bg-gradient-to-r from-primary/5 to-secondary/5" data-testid="section-cta">
            <CardContent className="p-12 text-center">
              ...
              <HTMLContent content={ctaData.description} className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto" data-testid="text-cta-description" />
