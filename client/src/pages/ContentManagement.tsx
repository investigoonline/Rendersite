...
export default function ContentManagement() {
  ...
  const heroImagePages = [
    { page: 'global', section: 'logo', label: 'Header Logo', description: 'Company logo displayed in header navigation (recommended: PNG with transparent background)' },
    ...
    { page: 'process', section: 'hero', label: 'Our Process Page Hero', description: 'Our Process page header image (under About Us)' },
          ...
          <TabsContent value="content" className="space-y-6">
            ...
            <Tabs value={selectedPage} onValueChange={setSelectedPage} className="space-y-6">
              <TabsList className="flex flex-wrap gap-1 lg:w-auto lg:inline-flex">
                ...
                <TabsTrigger value="flipbooks" data-testid="tab-flipbooks">Flipbooks</TabsTrigger>
