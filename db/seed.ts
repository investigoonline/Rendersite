...
async function seed() {
  ...
  const contentRows: Array<{ page: string; section: string; content: string }> = [
    ...
    { page: 'footer', section: 'footer_platform', content: '{"links":[{"href":"/calculators","label":"Financial Calculators"},{"href":"#","label":"Guest Access"},{"href":"#","label":"Client Login"},{"href":"#","label":"Mobile App"},{"href":"#","label":"API Documentation"}],"title":"Platform"}' },
    { page: 'footer', section: 'footer_resources', content: '{"links":[{"href":"/resources?type=article","label":"Articles & Insights"},{"href":"/resources?type=video","label":"Video Library"},{"href":"/resources?type=newsletter","label":"Market Newsletters"},{"href":"#","label":"FAQ Database"},{"href":"#","label":"Help Center"}],"title":"Resources"}' },
